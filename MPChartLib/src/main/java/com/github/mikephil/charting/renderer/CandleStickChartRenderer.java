    ...
    protected void drawDataSet(Canvas c, ICandleDataSet dataSet) {
        ...
        for (int j = mXBounds.min; j <= mXBounds.range + mXBounds.min; j++) {
            ...
            if (showCandleBar) {
                ...
                //for heart trend graph

                dummyPaint.setColor(Color.BLACK);
                dummyPaint.setStyle(Paint.Style.FILL);
                c.drawCircle(mShadowBuffers[0], mShadowBuffers[1], Utils.convertDpToPixel(3f), dummyPaint);
                dummyPaint.setColor(Color.parseColor("#AAACB0"));
                dummyPaint.setStyle(Paint.Style.FILL);
                c.drawCircle(mShadowBuffers[2], mShadowBuffers[3], Utils.convertDpToPixel(3f), dummyPaint);
                dummyPaint.setColor(Color.parseColor("#E9EEF6"));
                dummyPaint.setStyle(Paint.Style.FILL);
                c.drawCircle(mShadowBuffers[4], mShadowBuffers[5], Utils.convertDpToPixel(3f), dummyPaint);
